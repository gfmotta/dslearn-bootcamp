...
public class NotificationController {
	...
	@GetMapping
	public ResponseEntity<Page<NotificationDTO>> NotificationsPageByUser(Pageable pageable) {
		Page<NotificationDTO> page = service.getLoggedUsersNotification(pageable);
